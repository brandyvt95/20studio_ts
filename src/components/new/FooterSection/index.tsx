            ...
            <section className={s.footer_section} id="footer_section" ref={triggleSection}>
                <div className={s.container} ref={domEffect}>
                    ...
                    <ul className={s.social}>
                        <li className={s.item}>
                            <ButtonHoverNew data_id={2} targetRedirect='https://www.facebook.com/profile.php?id=100090452670743' classAdd={s.main_line}>
                                Facebook
                            </ButtonHoverNew>
                        </li>
                        <li className={s.item}>
                            <ButtonHoverNew data_id={5} targetRedirect='https://www.instagram.com/20studio.vn/' classAdd={s.main_line}>
                                Instagram
                            </ButtonHoverNew>
                        </li>
                    </ul>
